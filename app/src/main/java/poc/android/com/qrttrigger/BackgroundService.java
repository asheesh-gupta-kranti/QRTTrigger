...
public class BackgroundService extends Service {
    ...
    private class LocationListener implements android.location.LocationListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            Toast.makeText(BackgroundService.this, "Location:" + location.getLatitude() + "," + location.getLongitude(), Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(BackgroundService.this, "Successful", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(BackgroundService.this, "Something went wrong.", Toast.LENGTH_SHORT).show();
            }
        }) {
